...
class Settings(BaseSettings):
    ...
    JAEGER_OTLP_HTTP_ENDPOINT: str = "http://localhost:4318/v1/traces"  # OTLP HTTP endpoint for Jaeger
    ...
    model_config = ConfigDict(env_file=".env", env_file_encoding="utf-8")  # Configuration for environment variable loading


settings = Settings()  # Instantiate the Settings class
logger.info("⚙️ Application settings loaded")  # Log that the application settings have been loaded