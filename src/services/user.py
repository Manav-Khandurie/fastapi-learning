...
class UserService:
    ...
    def add_user(self, id: int, name: str) -> dict:
        ...
        Args:
            id (int): The ID of the new user.
            name (str): The name of the new user.

        Returns:
            dict: A message indicating the record has been inserted.
    ...
    def update_user(self, id: int, name: str) -> dict:
        ...
        Returns:
            dict: A message indicating the record has been updated.
    ...
    def delete_user(self, id: int) -> dict:
        ...
        Returns:
            dict: A message indicating the record has been deleted.
    ...
    def delete_users(self) -> dict:
        ...
        Returns:
            dict: A message indicating all records have been deleted.
        """
